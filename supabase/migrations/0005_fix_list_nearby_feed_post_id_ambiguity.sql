-- list_nearby_feed: fully qualify post_id references inside CTEs.
-- In PL/pgSQL, RETURNS TABLE output columns are visible as variables.
-- Unqualified "post_id" may become ambiguous (42702) between a PL/pgSQL
-- output variable and a table column.
