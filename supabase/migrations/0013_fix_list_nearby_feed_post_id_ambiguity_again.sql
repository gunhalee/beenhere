-- Hotfix: re-qualify post_id references inside list_nearby_feed.
-- Symptom:
--   ERROR 42702 "column reference post_id is ambiguous"
-- Cause:
--   RETURNS TABLE output column name post_id collided with unqualified
--   references in DISTINCT ON / ORDER BY within PL/pgSQL.
